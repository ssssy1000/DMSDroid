...
from .input_policy import UtgBasedInputPolicy, UtgNaiveSearchPolicy, UtgGreedySearchPolicy, \
    ...
    POLICY_MONKEY, POLICY_NONE
from droidbot.semantics import SemanticsEvents
...
class InputManager(object):
    ...
    def __init__(self, device, app, policy_name, random_input,
        ...
        # define semantic event sequences
        self.semantic_manager = SemanticsEvents(
            device=self.device
        )
    ...
    def add_event(self, event):
        ...
        event_log.start(self.semantic_manager)
        while True:
